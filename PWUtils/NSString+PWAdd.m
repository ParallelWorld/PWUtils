...
- (CGFloat)pw_widthForFont:(UIFont *)font {
    CGSize size = [self pw_sizeForFont:font size:CGSizeMake(MAXFLOAT, MAXFLOAT) mode:NSLineBreakByWordWrapping];
    return size.width;
}

- (CGFloat)pw_heightForFont:(UIFont *)font width:(CGFloat)width {
    CGSize size = [self pw_sizeForFont:font size:CGSizeMake(width, MAXFLOAT) mode:NSLineBreakByWordWrapping];
    return size.height;
}
